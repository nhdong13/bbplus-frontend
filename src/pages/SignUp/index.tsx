            ...
            <SignUpSuccessFormContainer>
              ...
              <Content>
                <div className="desktop">
                  ...
                  <p>You are just one step away from accessing Bedbank Plus platform, which connects you to a broad range of products across the South Pacific - from hotels, transfers, cruise,
                    sightseeing, and tours - at the most competitive prices.
                  </p>
                  <p>Our account manager will reach out to you in the next 48 hours to activate your account.</p>
                ...
                <div className="mobile">
                  <p>Dear Partner,</p>
                  <p>Your Application ID is: 12345</p>
                  <p className="text-normal mb-2">You are just one step away from accessing Bedbank Plus platform, which connects you to a broad range of products across the South Pacific - from hotels, transfers, cruise,
                    sightseeing, and tours - at the most competitive prices.Our account manager will reach out to you in the next 48 hours to activate your account.
                  </p>
